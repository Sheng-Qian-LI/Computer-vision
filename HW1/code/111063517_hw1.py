...
def main():
    ...
    image1 = cv2.cvtColor(cv2.imread(os.path.join(main_path, 'data', '2.jpg')), cv2.COLOR_BGR2RGB)
    image2 = cv2.cvtColor(cv2.imread(os.path.join(main_path, 'data', '1.jpg')), cv2.COLOR_BGR2RGB)
    ...
    plt.imsave(os.path.join(main_path, 'results', 'Kwa_Bungu', 'low_frequencies.png'), normalize(low_frequencies), dpi=95)
    plt.imsave(os.path.join(main_path, 'results', 'Kwa_Bungu', 'high_frequencies.png'), normalize(high_frequencies + 0.5), dpi=95)
    plt.imsave(os.path.join(main_path, 'results', 'Kwa_Bungu', 'hybrid_image.png'), normalize(hybrid_image), dpi=95)
    plt.imsave(os.path.join(main_path, 'results', 'Kwa_Bungu', 'hybrid_image_scales.png'), normalize(hybrid_image_scales), dpi=95)
