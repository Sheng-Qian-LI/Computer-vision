...
# from main import estimate_RT_from_E
# from main import nonlinear_estimate_3d_point
...
def remove_outliers(frame, threshold = 10.0):
    ...
    for i in range(frame.match_idx.shape[0]):
        ...
        pts2keep_indices = np.where(pts2keep)[0]
        frame.structure = frame.structure[pts2keep_indices, :]
        frame.match_idx = frame.match_idx[:, pts2keep_indices]
